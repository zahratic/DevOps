    ...
    <div class="container jumbotron">
        <div class="row">
            <div class="col-md-6  ">
                ...
                <p class="lead">DevTech est spécialisé dans la création de sites vitrines,<br>Accompagne les entrepreneurs, TPE, commerces, artisans et travailleurs indépendants qui souhaitent développer leur entreprise, ou leur activité en ligne</p>
            
            </div>
            <div class="col-md-6">
                <img src="{{URL::asset('images/ic_im.png')}}" alt="" class="img img-fluid">
            </div>
        </div>
       </div>
</section>
...
<div class="container footer" style="margin-block-start: 20%">
        ...
        <div class="row mb-4">
            <div class="col-md-4 col-sm-4 col-xs-4">
                <div class="footer-text pull-left">
                    ...
                    <p class="card-text">DevTech est spécialisé dans la création de sites vitrines et accompagne les entrepreneurs, TPE, commerces, artisans et travailleurs indépendants qui souhaitent développer leur entreprise, ou leur activité en ligne.</p>
